...
if($query->rowCount() > 0)
{
									...
									<div class="booking-form">
										...
										<form name="book" method="post" onsubmit = "return validateForm()">
											<h4> Mã tour:<b>  BKG-0<?php echo htmlentities($result->id_goi);?><b> </h4><br>
												...
												<p><h4><i class="fas fa-clock"></i> Giờ xuất phát: <?php echo htmlentities($result->giodi);?> </h4></p>
												...
												<div class="form-group"> <label>Người lớn: </label>
												...
												<div class="form-group"> <label>Trẻ em: </label>
												...
												<div class="form-group"> <label>Trẻ nhỏ: </label>
												...
												<div class="form-group"> <label>Em bé: </label>
												...
												<div class="form-group"> <label>Phòng đơn: </label>
												...
												<div class="form-group right-icon"> <label>Thanh toán: </label>
											...
											<div><img src="images/tour/<?php echo htmlentities($result->hinhanh);?>" class="img-responsive" alt="feature-img" style="    height: 480px; width: 880px;"/>
												<div class="col-xs-12 col-sm-2 col-md-2 dashboard-nav">
													<ul style="width: max-content; margin-top: 30px; list-style: none; margin-left: -230px; font-size: 20px;">
														<p style="margin-top: -19px;margin-left: 190px;"> <i class="fas fa-layer-group"></i> Giới thiệu</p>
														

														<li style="margin-top: -30px;    margin-left: 390px;"><a href="tour-program.php?pkgid=<?php echo htmlentities($result->id_goi);?>"><span><i class="fas fa-dolly-flatbed"></i></span> Chương trình</a></li>

														<li style="margin-top: -31px;margin-left: 641px;"><a href="tour-note.php?pkgid=<?php echo htmlentities($result->id_goi);?>"><span><i class="fas fa-exclamation-circle"></i></span> Lưu ý</a></li>
													</ul>
												</div><br>
												...
												<br><H3>Giới thiệu: </H3>
												<p style="padding-top: 1%"><?php echo ($result->chitietgoi);?></p>   
											</div>
										</div>
	...
	<script type = "text/javascript">
         function validateForm()  {
             ...
             var c = document.getElementById("trenho").value;
             var d = document.getElementById("embe").value;
             var e = document.getElementById("phongdon").value;
 

              if(b <= -1) {
                 alert("Nhập sai số. Vui lòng nhập lại!!!");
                 return false;
             }
