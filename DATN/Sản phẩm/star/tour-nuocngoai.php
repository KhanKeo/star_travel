...
<body>
  ...
  <div class="container" style="    margin-top: -30px;" >
    <div class="row">
      <div class="col-sm-12" >
        <h1 class="page-title">tour nước ngoài</h1>
        <ul class="breadcrumb">
            ...
            <div class="container">
                <div class="row">           
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-9 col-lg-9 content-side">
                       <?php $sql = "SELECT * from goidulich where nuocngoai = 1 order by ngayxuatphat";
                                    ...
                                    <div class="list-content">
                                        <div class="main-img list-img t-list-img">
                                            ...
                                            <div class="main-mask">
                                                <ul class="list-unstyled list-inline offer-price-1">
                                                    <li class="price" style=" margin-left: 25px;"><?php echo number_format($result->giagoi);?>VND<span class="pkg"></span></li>
                                                    <li class="rating">
                                        ...
                                        <div class="list-info t-list-info">
                                            ...
                                            <div style="float: left;">
                                                <p style="width: 250px;"><i class="fas fa-flag"></i> Quốc gia: <?php echo htmlentities($result->quocgia);?></p>
                                                <p style="width: 250px;"><i class="fas fa-map-marker-alt"></i> Điểm đến: <?php echo htmlentities($result->vitri);?></p>
                                                <p style="width: 250px;"><i class="fas fa-street-view"></i> Điểm xuất phát: <?php echo htmlentities($result->noixuatphat);?></p>
                                            </div>
