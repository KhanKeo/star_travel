...
<div class="main_right" style="margin-top: -20px; margin-left: -20px; float: left;  ">
	...
	<div class="main_right_content">
		<nav class="menu1" style="margin-top: 230px;     margin-left: 515px;">
			...
			<a href="manage-flight.php" class="menu1-item1 blue" style="font-size: 20px;">
				...
				<?php echo htmlentities($ks);?> Khách sạn  </a>
					<a href="manage-cruise.php" class="menu1-item1 red" style="font-size: 20px;"><?php echo htmlentities($cnt2);?> Góp ý</a>
               <a href="manage-packages.php" class="menu1-item1 orange" style="font-size: 20px;"><?php echo htmlentities($goi);?> Tour</a>
					<a href="manage-car.php" class="menu1-item1 purple" style="font-size: 20px;"><?php echo htmlentities($cnt5);?> Câu hỏi</a>
